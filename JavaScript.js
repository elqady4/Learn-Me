		...
		//Clear Local Storage Every 5 sec
		...
		//Get Image Tage That Hold Image Of Letter
		...
		butt.addEventListener('click',function(e){
			...
			localStorage.setItem("Generate"+counter,tempLocalStorage(e.target.textContent,e.type,new Date()));
			counter++;
			localStorage.setItem("counter",counter);
		 ...
		 // Selecting the input element and get its value 
			...
			//Get Random Letters without duplicate
